...
namespace AppRegistryService.Exceptions;
...
public sealed class ServiceException : Exception
{
    ...
    /// Error code.
    /// </summary>
    public WellKnownAppRegistryServiceErrorCode ErrorCode { get; }
    ...
    public ServiceException(
        WellKnownAppRegistryServiceErrorCode errorCode,
    ...
    public ServiceException(WellKnownAppRegistryServiceErrorCode errorCode, HttpStatusCode statusCode, Exception? innerException)
